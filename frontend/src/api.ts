...
export type RevisionResponse = { revision_id: string; packet: { status: "ready" | "review_required"; summary: string; cited_evidence_ids: string[]; recommended_owners: string[]; distinguishes_unknowns: boolean }; evaluation: { readiness: string; can_create_followup: boolean }; trace: TraceEntry[] };
